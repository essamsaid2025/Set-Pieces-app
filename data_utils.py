...
TEXT_COLS = [
    ...
    "play_type", "event", "side", "delivery_type", "taker", "phase", "target_zone",
    "outcome", "result", "target_player", "first_contact_player",
    "shot_player", "lost_first_contact_player", "routine_type",
]
...
COLUMN_ALIASES: Dict[str, List[str]] = {
    ...
    "play_type": ["type","play_type","play type","attack_defence","attack_defense","phase_type"],
    ...
    "man_marking_in_box": ["man_marking_in_box","man marking in box","man_marking","man marking"],
    "zonal_marking_in_box": ["zonal_marking_in_box","zonal marking in box","zonal_marking","zonal marking"],
    "lost_first_contact_player": ["lost_first_contact_player","lost first contact player","player_lost_first_contact"],
...
def normalize_set_piece_df(df: pd.DataFrame) -> pd.DataFrame:
    ...
    if "play_type" in out.columns:
        out["play_type"] = out["play_type"].replace({
            "attacking":"attack", "offense":"attack", "offence":"attack",
            "defensive":"defence", "defense":"defence",
        })
